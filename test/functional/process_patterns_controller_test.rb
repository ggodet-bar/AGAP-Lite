...
class ProcessPatternsControllerTest < ActionController::TestCase
  ...
  test "should route to pattern_system" do
    get :index, {:pattern_system_id  => pattern_systems(:a_test_pattern_system).short_name}
    assert_redirected_to pattern_system_path(pattern_systems(:a_test_pattern_system))
  end
  
  test "should route to new process_pattern" do
    opts = {:controller => 'process_patterns', :action => 'new', :pattern_system_id => pattern_systems(:a_test_pattern_system).short_name}
    assert_routing({:method => 'get', :path => "pattern_systems/#{pattern_systems(:a_test_pattern_system).short_name}/process_patterns/new"}, opts)
  end
  
  test "should route to create process_pattern" do
    opts = {:controller => 'process_patterns', :action => 'create', :pattern_system_id => pattern_systems(:a_test_pattern_system).short_name}
    assert_routing({:method => 'post', :path => "pattern_systems/#{pattern_systems(:a_test_pattern_system).short_name}/process_patterns"}, opts)
  end
  
  test "should get new" do
    get :new, {:pattern_system_id  => pattern_systems(:a_test_pattern_system).short_name}
    assert_response :success
  end

  test "should not accept pattern creation" do
    assert_no_difference('ProcessPattern.count') do
      post :create, {:process_pattern => {:name => "Yay, a great name fo'sure"}, :pattern_system_id => pattern_systems(:a_test_pattern_system).short_name}
  ...
  test "should create process_pattern" do
    assert_difference('ProcessPattern.count') do
      post :create, {:process_pattern => {:name => "Yay, a great name fo' sure", :author => "Bob le poulpe"}, :pattern_system_id  => pattern_systems(:a_test_pattern_system).short_name}
    end
  ...
  test "should save new image with new process_pattern" do
    assert_difference(['ProcessPattern.count','MappableImage.count']) do
        post :create, {
                        ...
                        :pattern_system_id  => pattern_systems(:a_test_pattern_system).short_name}
    end
    assert_redirected_to([pattern_systems(:a_test_pattern_system), assigns(:process_pattern)])
  end

  test "should show process_pattern" do
    get :show, {:id => process_patterns(:first_pattern).id, :pattern_system_id  => pattern_systems(:a_test_pattern_system).short_name}
    assert_response :success
  end

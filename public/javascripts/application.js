...
Event.observe(window, 'load', function(){
	...
	$('plus_sign').observe('click', function(){
		...
		$('validate_area').observe('click', function(){
			...
			var param = {x: rect_x - image.cumulativeOffset().left,	y: rect_y - image.cumulativeOffset().top,	w: rect_w, h: rect_h} ;
...
function registerArea(current_pattern_id, pattern_id, x, y, w, h) {
	...
	var new_link = new Element('a', {id: "link_" + pattern_id, href: "../" + pattern_id}) ;
